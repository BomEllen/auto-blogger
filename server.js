...
네이버 검색 상위 노출을 위한 제목 작성 규칙:
1. 필수 포함: 지역명 + 장소명 → 브랜드 검색 + 지역 검색 동시 노출
2. 아래 리스트 중 검색량 높은 키워드 1~2개를 자연스럽게 조합:
...
3. 40자 이내, 키워드를 나열하지 말고 자연스럽게 읽히는 문장형으로 작성
4. 좋은 예시: "성수동 감성카페 OO, 데이트 코스로 강추", "홍대 뷰 맛집 카페OO 내돈내산 솔직후기", "강남 가성비맛집 OO식당 주차도 가능해요"
5. 나쁜 예시: "OO카페 리뷰" (키워드 부족), "홍대 핫한 감성 인스타 뷰맛집 카페OO 내돈내산 솔직후기 강추" (너무 길고 나열식)
